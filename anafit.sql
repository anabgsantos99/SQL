...
--Inserindo cinco dados ao mesmo tempo na tabela de cliente
INSERT INTO cliente(cpf, primeironome, sobrenome, datanasc, peso, altura, whatsapp, email, rua, numero, complemento, cep)
VALUES
...
("2025-03-12", "19:00:00", "Musculação");
...
VALUES
(150.00, "2025-03-01", 12345678911),  -- Pagamento João
(200.00, "2025-03-05", 12345678912),  -- Pagamento Maria
(300.00, "2025-03-10", 12345678913),  -- Pagamento Carlos
(250.00, "2025-03-02", 12345678911),  -- Outro pagamento João
(100.00, "2025-03-03", 12345678915);  -- Pagamento Lucas
...
WHERE horario IN ("18:00:00", "19:00:00");

--Alterar dois registros diferentes na mesma tabela 
UPDATE cliente
...
-- Somar todos os pessos do registro
SELECT SUM(peso) AS soma_peso FROM cliente;

--Contar quantos registros eu tenho na tabela de cliente
...
SELECT * FROM cliente
WHERE primeironome LIKE '%Beatriz%';

--Selecionando um dado na tabela que contenha a letra "a" e "s"
SELECT * FROM cliente
WHERE primeironome LIKE '%a%'AND sobrenome LIKE '%s%';

--Selecionando duas colunas com dado exato
SELECT * FROM cliente
WHERE primeironome LIKE '%Beatriz%'AND sobrenome LIKE '%Santos%';

--Selecionando um dado que contenha um valor com casa decimal
SELECT * FROM pagamento
WHERE CAST(valor AS CHAR) LIKE '%150.00%';

--Selecionando pagamento que contenha um valor com 00
SELECT * FROM pagamento
